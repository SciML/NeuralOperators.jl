...
"""
    ...
    timed = timeit.timeit(setup = import_code+ setup_code, stmt = test_code, number = n_iters)
...
print("| --- | --- | --- |")
for i in range(1,6):
    print("| ", i, " | ", fwd_timed_arr[i-1]/n_iters * 1000, " ms | ", training_timed_arr[i-1]/n_iters * 1000, " ms |")
